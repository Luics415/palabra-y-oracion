...
function RosarioCompleto(){
  ...
  return(0,J.jsxs)("div",{className:"mx-auto max-w-4xl px-4 py-10",children:[
    ...
    (0,J.jsxs)("div",{className:"sticky top-0 z-30 mt-6 rounded-xl border bg-card/95 p-4 shadow-sm backdrop-blur",children:[
    ...
    (0,J.jsx)("div",{className:"mt-8 space-y-5",children:pasos.map(function(paso,index){var active=index===current;return(0,J.jsxs)("article",{id:"rosario-paso-"+index,onClick:function(){seleccionarPaso(index)},"aria-current":active?"step":undefined,className:"cursor-pointer rounded-2xl border p-3 transition-all sm:p-6 "+(active?"border-gold bg-accent/15 shadow-md ring-1 ring-gold/20":"bg-card shadow-sm hover:border-accent/60 hover:bg-accent/10"),children:[
      paso.repetitions&&(0,J.jsx)("div",{className:"mb-5 flex items-center justify-center gap-1",role:"group","aria-label":"Cuentas del Ave María",children:Array.from({length:paso.repetitions},function(_,cuenta){var numero=cuenta+1,marcada=active&&numero<=bead;return(0,J.jsx)("button",{type:"button",onClick:function(event){event.stopPropagation();seleccionarPaso(index,numero)},"aria-label":"Ave María "+numero+" de "+paso.repetitions,className:"flex h-7 w-7 shrink-0 items-center justify-center rounded-full border-2 p-0 text-xs font-bold leading-none transition-all "+(marcada?"border-gold bg-gold text-primary shadow-sm":"border-accent/50 bg-background text-muted-foreground hover:border-gold"),children:numero},numero)})}),
      (0,J.jsxs)("div",{className:"relative",children:[(0,J.jsx)("h2",{className:"px-14 text-center font-serif text-2xl font-semibold leading-tight text-foreground sm:text-3xl",children:paso.label}),paso.decade&&(0,J.jsxs)("span",{className:"mx-auto mt-2 block w-fit rounded-full bg-secondary px-2.5 py-0.5 text-xs text-muted-foreground",children:["Decena ",paso.decade]}),active&&(0,J.jsx)("span",{className:"absolute right-0 top-1 text-xs font-medium uppercase tracking-wider text-accent-foreground",children:speaking?"Leyendo":"Tu lugar"})]}),
      paso.repetitions&&(0,J.jsxs)("p",{className:"mt-3 text-center text-sm font-medium text-accent-foreground",children:["Cuenta ",active?bead:1," de ",paso.repetitions]}),
